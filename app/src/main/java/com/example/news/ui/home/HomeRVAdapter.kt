...
class HomeRVAdapter(var context: Context,var articles: ArrayList<Articles>,var onHomeRvClickListener: OnHomeRvClickListener) : RecyclerView.Adapter<HomeRVAdapter.Holder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        var v:View=LayoutInflater.from(parent.context).inflate(R.layout.custom_home_row,null,false)
        return Holder(v)
    }
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.favoImg.setOnClickListener {
            onHomeRvClickListener.onClick(it,articles.get(position))
        }
